...
export function TitleScreen({ onStart, highScore }) {
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', width: '100%', maxWidth: '280px' }}>
        <button
          ...
          style={{
            ...
            boxShadow: '0 0 25px rgba(139, 0, 0, 0.5)',
            minHeight: '56px',
          }}
        >
          ⚔️ ENTER THE ARENA
        ...
        <button
          onClick={() => {
            if (confirm('Reset all progress? This cannot be undone.')) {
              ...
              localStorage.removeItem('titan-rise-upgrades')
              localStorage.removeItem('titan-rise-highscore')
            }
          }}
          style={{
            padding: '12px 24px',
      ...
      {screen === 'stats' && (
        <div style={{
          ...
          <div style={{ color: COLORS.TITANS_GOLD, fontSize: '24px', fontWeight: 'bold', marginBottom: '20px', letterSpacing: '2px' }}>
            WARRIOR STATS
          </div>
          ...
          <div style={{ color: 'rgba(255,255,255,0.6)', fontSize: '13px', marginBottom: '8px' }}>Wave Reached: {gameStore.wave}</div>
          <div style={{ color: 'rgba(255,255,255,0.6)', fontSize: '13px', marginBottom: '24px' }}>Best Score: {highScore}</div>
